...
test("getYear", () => {
    ...
    expect((new ModelParser('Certified 2018 Toyota Camry SE')).getYear()).toBe(2018);
});
...
test("getModel", () =>  {
    ...
    expect((new ModelParser('Certified 2018 Toyota Camry SE')).getModel()).toBe('Toyota Camry SE');
});
